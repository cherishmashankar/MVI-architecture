...
class BlogListAdapter(private val interaction: Interaction? = null) :
    ...
    val DIFF_CALLBACK = object : DiffUtil.ItemCallback<Blogs>() {
    ...
    fun submitList(list: List<Blogs>) {
    ...
    constructor(
        ...
        fun bind(item: Blogs) = with(itemView) {
    ...
    interface Interaction {
        fun onItemSelected(position: Int, item: Blogs)
    }
}